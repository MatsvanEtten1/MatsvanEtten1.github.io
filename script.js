(async () => {
    ...
    const sounds = {
        "Zonlicht": new Audio("my_sounds/zon.mp3"),
        "Water": new Audio("my_sounds/water.mp3"),
        "Voeding": new Audio("my_sounds/voedsel.mp3")
    };

    const images = {
        "Zonlicht": "my_images/zonlicht.png",
        "Water": "my_images/water.png",
        "Voeding": "my_images/voeding.png",
